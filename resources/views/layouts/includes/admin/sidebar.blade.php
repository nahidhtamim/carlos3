<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        <a href="{{url('/dashboard')}}" class="navbar-brand mx-4 mb-3">
            <h3 class="text-primary"> <i class="fa fa-hashtag me-2"></i>Usina Corurpe</h3>
        </a>
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="{{url('/view-categories')}}" class="nav-item nav-link"><i class="fa fa-info me-2"></i>Categories</a>
            <a href="{{url('/view-products')}}" class="nav-item nav-link"><i class="fa fa-info me-2"></i>Products</a>
