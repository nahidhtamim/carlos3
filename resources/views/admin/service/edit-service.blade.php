            ...
            <div class="card-body">
                <form action="{{url('update-service/'.$service->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description_one" class="form-control description description_one @error('description_one') is-invalid @enderror" id="description_one" cols="30" rows="5" required>{{$service->description_one}}</textarea>
                        <span class="text-danger">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description_two" class="form-control description description_two" id="description_two" cols="30" rows="5">{{$service->description_two}}</textarea>  
                    </div>
                    <br>
                    <div class="form-group">
