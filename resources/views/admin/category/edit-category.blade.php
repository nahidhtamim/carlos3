...
@section('title')
Edit Equipment Card | Usina Corurpe
@endsection
@section('contents')
    ...
    <div class="col-md-8 m-auto">
        ...
        <div class="card bg-light shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Edit Category Item</h6>
            </div>
            <div class="card-body">
                <form action="{{url('update-category/'.$category->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <img src="{{asset('upload/category/'.$category->image)}}" alt="" height="150px" width="220px">
                    </div>
                    <br>
